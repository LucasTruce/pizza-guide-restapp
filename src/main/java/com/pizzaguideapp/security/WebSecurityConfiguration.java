...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        	...
        	http.cors().and().csrf().disable()
                    ...
                    .antMatchers(HttpMethod.POST,"/auth/signin", "/auth/signup").permitAll() //register and auth user
                    ...
                    .antMatchers(HttpMethod.GET, "/recipes/{id}/steps").hasAnyRole("ADMIN", "USER") //get all steps - only admin
                    .antMatchers(HttpMethod.POST, "/recipes/{id}/steps").hasAnyRole("ADMIN", "USER") //save step for recipe
                    .antMatchers(HttpMethod.GET, "/recipes/{id}/media").hasAnyRole("ADMIN", "USER")
