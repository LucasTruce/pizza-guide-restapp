...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        	...
        	http.cors().and().csrf().disable()
                    ...
                    .antMatchers(HttpMethod.GET, "/steps").hasRole("ADMIN")
                    .antMatchers(HttpMethod.POST, "/recipes/{id}/steps").hasAnyRole("ADMIN", "USER")
                    .antMatchers(HttpMethod.POST, "/recipes/{id}/media").hasAnyRole("ADMIN", "USER")
